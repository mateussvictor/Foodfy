module.exports = [
  {
    ...
    ingredients: [
      ...
      '1/4 cups breadcrumbs (fresh soft)',
      '1 large egg',
      '1/2 teaspoon salt',
  ...
  },
  {
    ...
    preparation: [
      'In a blender, beat the milk, egg, salt, sugar, butter, flour and baking powder until everything is well mixed.',
      'Pour the dough into a pizza pan. Grease the pan with butter and bake in the preheated oven for 20 minutes. ',
      'Remove from the oven and pour the tomato sauce.',
      'Cover the pasta with grated mozzarella, tomato and oregano to taste.',
      'Bake again until the mozzarella melts.',
    ],
    information:
      'Blender pizza is a delicious and super simple recipe to prepare. Made entirely in a blender, it is very practical for everyday use. Here at Foodfy, you will also find many practical delights made in a blender: pancake batter, blender chicken pie, blender cheese bread, banana cake, chocolate cake and more! ',
  },
  {
    image_url:
    ...
    preparation: [
      'In a bowl, place the chicken wings, pass the flour and mix with your hands.',
      'In a frying pan or roaster, add the oil when it is hot and fry until golden brown.',
      'To serve, look good with salad, or show your creativity.',
    ],
    information: '',
  },
  {
    ...
    ingredients: [
      ...
      '2 glasses of curd',
      '150g of mozzarella for gratin',
    ],
    preparation: [
      'In a pan, put the butter to melt.',
      'Add the wheat flour and mix well using a mixer.',
  ...
  },
  {
    ...
    preparation: [
      'When the pasta is about 5 minutes left to be ready, start preparing the recipe.',
      'In the hot skillet, place the butter, oil, bay leaf and granulated garlic.',
      'The drained pasta goes to the pan, being stirred and dosed with salt to taste, the herbs, the powdered ginger to taste as well.',
    ...
    information:
      'Do not wash the pasta or oil or grease it after draining it. Put it right in the pan. ',
  },
  {
    image_url:
    ...
    preparation: [
      ...
      'Add the butter, eggs, desiccated coconut, sugar, condensed milk and baking powder, stirring well after each addition.',
      'Pour into a greased, medium rectangular baking dish and place in a medium oven (180 ° C) for approximately 45 minutes.',
      'After cold, sprinkle, pass the icing sugar and cut into squares.',
    ],
    information: '',
  },
];
