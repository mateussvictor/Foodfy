...
async function show(req, res, next) {
  ...
  if (!user) return res.render('admin/user/login', {
...
async function update(req, res, next) {
  ...
  if (email != user.email) {
    ...
    if (isNotAvaliable) return res.render('admin/user/profile', {
      user: req.body,
  ...
  if (!passwordPassed) return res.render('admin/user/profile', {
    user: req.body,
